 ...
 */
#ifndef ON_OFF_PRO_HELPER_H
#define ON_OFF_PRO_HELPER_H
 ...
 * on a set of nodes.
 */
class OnOffProHelper
{
public:
  /**
   * Create an OnOffProHelper to make it easier to work with OnOffApplications
   *
   ...
   *        to.
   */
  OnOffProHelper (std::string protocol, Address address);
